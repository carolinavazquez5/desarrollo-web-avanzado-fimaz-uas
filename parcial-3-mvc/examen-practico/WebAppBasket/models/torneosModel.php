<?php
    ...
    class torneosModel {
        ...
        public function insert($id, $nombreTorneo, $organizador, $patrocinadores, $sede, $categoria,
        ...
        public function passwordEncrypt($password){
            $passwordDencrypted = password_hash($password, PASSWORD_DEFAULT);
            return $passwordDencrypted;  
        }
        ...
        //Crearemos le método para listar todos los torneos.
        ...
        $premio1, $premio2, $premio3, $otroPremio){
            ...
            = :categoria, premio1 = :premio1, premio2 = :premio2, premio3 = :premio3, 
